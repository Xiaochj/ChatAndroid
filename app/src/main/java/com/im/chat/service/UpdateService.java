...
//import com.im.chat.util.NetAsyncTask;
...
//              builder.setTitle(com.im.chat.R.string.update_service_haveNewVersion)
//                  .setMessage(info.getDesc())
//                  .setPositiveButton(com.im.chat.R.string.update_service_installNewVersion, new DialogInterface.OnClickListener() {
//
//                    @Override
//                    public void onClick(DialogInterface dialog, int which) {
//                      openUrlInBrowser(info.getApkUrl());
//                    }
//                  }).setNegativeButton(com.im.chat.R.string.update_service_laterNotify, null).show();
//            }
//          } else {
//            if (curVer == ver) {
...
//                String title = UpdateService.this.activity.getString(com.im.chat.R.string.update_service_updateLog);
...
//            builder.setTitle(com.im.chat.R.string.update_service_sureToUpdate)
//                .setMessage(info.getDesc())
//                .setPositiveButton(com.im.chat.R.string.chat_utils_right, new DialogInterface.OnClickListener() {
//                  @Override
//                  public void onClick(DialogInterface dialog, int which) {
//                    openUrlInBrowser(info.getApkUrl());
//                  }
...
//          } else {
//            Utils.toast(ctx, com.im.chat.R.string.update_service_versionIsAlreadyNew);
//          }
//        } else {
